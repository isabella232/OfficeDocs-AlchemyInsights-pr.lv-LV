...
Lai atreģistrētu centrmezgla vietnes jaunā SharePoint administrēšanas centrs:
  
1. Jaunajā SharePoint administrēšanas centrā sadaļā **vietnes**noklikšķiniet uz **aktīvās vietnes**.

2. Atlasiet vietni, noklikšķiniet uz **centrmezgla vietne**un pēc tam noklikšķiniet uz **Noņemt reģistrāciju centrmezgla vietnē**.
