...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="d3848-102">Piekļuve domēnu lapai</span><span class="sxs-lookup"><span data-stu-id="d3848-102">Access the Domains Page</span></span>

<span data-ttu-id="d3848-103">Lai piekļūtu domēnu lapai, vienkārši noklikšķiniet uz šīs ikonas:</span><span class="sxs-lookup"><span data-stu-id="d3848-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="d3848-104">Pēc tam varat pievienot, modificēt vai noņemt domēnu.</span><span class="sxs-lookup"><span data-stu-id="d3848-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="d3848-105">Lai iegūtu papildinformāciju, skatiet [bieži uzdotie jautājumi par domēniem.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="d3848-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
