...
ms.locfileid: "36507170"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="6eb85-102">Piekļuves lapa Domēni</span><span class="sxs-lookup"><span data-stu-id="6eb85-102">Access the Domains Page</span></span>

<span data-ttu-id="6eb85-103">Lai piekļūtu lapai domēnu, vienkārši noklikšķiniet uz šīs ikonas zemāk:</span><span class="sxs-lookup"><span data-stu-id="6eb85-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="6eb85-104">Pēc tam var pievienot, modificēt vai noņemt savu domēnu.</span><span class="sxs-lookup"><span data-stu-id="6eb85-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="6eb85-105">Lai iegūtu papildinformāciju, skatiet [FAQ domēni.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span><span class="sxs-lookup"><span data-stu-id="6eb85-105">For more information, see the [Domains FAQ.](https://support.office.com/article/1272bad0-4bd4-4796-8005-67d6fb3afc5a.aspx)</span></span>
