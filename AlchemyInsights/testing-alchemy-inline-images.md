---
title: Testēšana Alchemy inline Images
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
ms.locfileid: "44505062"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="645fd-102">Piekļuve domēnu lapai</span><span class="sxs-lookup"><span data-stu-id="645fd-102">Access the Domains Page</span></span>

<span data-ttu-id="645fd-103">Lai piekļūtu domēnu lapai, vienkārši noklikšķiniet uz šīs ikonas:</span><span class="sxs-lookup"><span data-stu-id="645fd-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="645fd-104">Pēc tam varat pievienot, modificēt vai noņemt domēnu.</span><span class="sxs-lookup"><span data-stu-id="645fd-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="645fd-105">Lai iegūtu papildinformāciju, skatiet [bieži uzdotie jautājumi par domēniem.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="645fd-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
