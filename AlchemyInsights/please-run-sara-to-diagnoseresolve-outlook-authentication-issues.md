...
ms.locfileid: "30772623"
---
# <a name="use-sara-to-diagnose-and-resolve-outlook-authentication-issues"></a><span data-ttu-id="02c5f-102">SaRA jālieto diagnosticē un risina ar Outlook autentifikāciju jautājumiem</span><span class="sxs-lookup"><span data-stu-id="02c5f-102">Use SaRA to diagnose and resolve Outlook authentication issues</span></span>

<span data-ttu-id="02c5f-103">Mēs ļoti iesakām izmantojat [Outlook glabā lūdzot manu paroli](https://aka.ms/SaRA-OutlookPwdPrompt) diagnostikas skarto datorā novērst problēmas ja Outlook pastāvīgi pieprasa paroli.</span><span class="sxs-lookup"><span data-stu-id="02c5f-103">We highly recommend you use the [Outlook keeps asking for my password](https://aka.ms/SaRA-OutlookPwdPrompt) diagnostic on the affected machine to troubleshoot issues where Outlook continually prompts for a password.</span></span> <span data-ttu-id="02c5f-104">Šo [SaRA](https://diagnostics.office.com/#/) diagnostikas vai automatizētas kontroles un atgriež iespējamos risinājumus var izmantot, lai risinātu visas atklātās problēmas.</span><span class="sxs-lookup"><span data-stu-id="02c5f-104">This [SaRA](https://diagnostics.office.com/#/) diagnostic does automated checks and returns possible solutions for you to use to address any detected issues.</span></span> 
