...
---
# <a name="business-rule-not-firing-for-a-form"></a>Uzņēmuma kārtulas, kas netiek apšautas veidlapā

Biznesa kārtula var netikt izpildīta, jo šajā formā nav atsauces uz biznesa kārtulu. Papildinformāciju skatiet rakstā [vai jūsu uzņēmuma noteikums nešaujas uz veidlapu?](https://docs.microsoft.com/powerapps/maker/model-driven-apps/create-business-rules-recommendations-apply-logic-form#is-your-business-rule-not-firing-for-a-form).
