...
---
# <a name="cant-add-default-2010-approval-workflow"></a>Nevar pievienot noklusējuma apstiprinājuma darbplūsma 2010
...
4. Formā **Izveidot izmantojama darbplūsmas** ievadiet nosaukumu * **Repair2010***. **Platformas tips**atlasiet **SharePoint 2010 darbplūsma**un pēc tam **Labi**. 
  
5. Sadaļā **Saglabāt** **darbplūsmas** lentes, atlasiet **publicēt**. 
  
6. **Darbplūsmā** lentei sadaļā **Pārvaldīt** atlasiet **Publicēt globāli**. Apstiprinājuma dialoglodziņā, kas parādās, izvēlieties **Labi**. 
  
7. Web pārlūkprogrammā, atrast saknes tīmekļa vietņu kolekcijas, un pēc tam piekļūt **Vietnes iestatījumus** \> **Vietņu kolekcijas līdzekļus**. Tad, pretēji **darbplūsmas** līdzeklis: 
