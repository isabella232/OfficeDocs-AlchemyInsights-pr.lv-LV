...
1. Augšējā labajā stūrī izvēlieties **uzstādījumi** \> **Outlook iestatījumu skatīšana**.
    
2. Zem **Vispārīgi**atzīmējiet [**valodu un laiku**](https://outlook.live.com/mail/options/general/timeAndLanguage).
    
3. Izvēlieties savu valodu.
