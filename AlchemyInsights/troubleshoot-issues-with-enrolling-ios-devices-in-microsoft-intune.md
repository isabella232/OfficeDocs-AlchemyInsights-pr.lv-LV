...
- **Šo pakalpojumu, netiek atbalstīta. Nav reģistrācijas politika:** Apple Push paziņojums pakalpojumu (APN) nepieciešams konfigurēt vai atjaunot. Recenzējiet [šo dokumentu](https://docs.microsoft.com/en-us/intune/apple-mdm-push-certificate-get) norādījumus par to, kā to izdarīt. 
...
3. [Uzziniet, kā pieteikties Microsoft Intune iOS ierīcēm](https://docs.microsoft.com/en-us/intune/ios-enroll).
