...
---
# <a name="teams-supported-web-browsers"></a><span data-ttu-id="038eb-102">Teams atbalstītās tīmekļa pārlūkprogrammas</span><span class="sxs-lookup"><span data-stu-id="038eb-102">Teams-supported web browsers</span></span>

<span data-ttu-id="038eb-103">Teams pilnībā atbalsta interneta pārlūkprogrammas, kas norādītas rakstā, [Microsoft Teams ierobežojumi un specifikācijas](https://docs.microsoft.com/microsoftteams/limits-specifications-teams#browsers), ar atzīmējusi izņēmumus zvanīšanai un sanāksmēm.</span><span class="sxs-lookup"><span data-stu-id="038eb-103">Teams fully supports the Internet browsers listed in the article, [Limits and specifications for Microsoft Teams](https://docs.microsoft.com/microsoftteams/limits-specifications-teams#browsers), with noted exceptions for calling and meetings.</span></span>