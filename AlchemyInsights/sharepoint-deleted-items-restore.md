...
ms.locfileid: "50708285"
---
# <a name="restore-deleted-items-from-sharepoint"></a>Izdzēsto vienumu atjaunošana no SharePoint

Izdzēšot vienumu vai vietni no SharePoint, tas netiek noņemts tūlīt. Izdzēstie vienumi tiek ievietoti atkritnē noteiktā laika periodā. Šajā laikā varat atjaunot vienumus, kurus izdzēsāt to sākotnējā atrašanās vietā. Lai iegūtu papildinformāciju, skatiet tālāk norādītās saites.
...
- [Atjaunojiet izdzēstas vietņu kolekcijas (ieskaitot grupu, saziņu un citas vietnes)](https://docs.microsoft.com/sharepoint/restore-deleted-site-collection ).

- [Izdzēsta OneDrive atjaunošana](https://docs.microsoft.com/onedrive/restore-deleted-onedrive)
